...
(function($, videojs, undefined) {
   ...
   var defaultSetting = {
      markerStyle: {
         'width':'24px',
         'height':'24px',
         'background':'url(/res/common/video/images/playerMarker.png) no-repeat 0 -1px',
         'z-index':'15',
      },
      markerTip: {
         display: true,
      ...
      function createMarkerDiv(marker, duration) {
         ...
         markerDiv.on('click', function(e) {
            ...
            if (!preventDefault) {
            	...
            	if ( (playerData.limit_range == true && playerData.limit_time > player.currentTime()) || playerData.limit_range == false) {
